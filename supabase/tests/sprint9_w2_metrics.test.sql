...
insert into public.equipes (id, nome, crm_link, suporte_link) values
  ('11111111-1111-1111-1111-111111111111', 'Alfa', 'x', 'y'),
  ('99999999-9999-9999-9999-999999999999', 'Outro Tenant', 'x', 'y');

-- Two humans in Alfa: one admin, one plain seat.
insert into auth.users (id, instance_id, aud, role, email, encrypted_password, created_at, updated_at)
values
  ('d0000000-0000-0000-0000-0000000000a1','00000000-0000-0000-0000-000000000000','authenticated','authenticated','chefe@alfa.test','x',now(),now()),
  ('d0000000-0000-0000-0000-0000000000a2','00000000-0000-0000-0000-000000000000','authenticated','authenticated','vendedor@alfa.test','x',now(),now());
...
insert into public.profiles (id, user_id, email, equipe_id, nome_completo, role) values
  ('d0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','chefe@alfa.test','11111111-1111-1111-1111-111111111111','Chefe','admin'),
  ('d0000000-0000-0000-0000-0000000000a2','d0000000-0000-0000-0000-0000000000a2','vendedor@alfa.test','11111111-1111-1111-1111-111111111111','Vendedor','user')
...
insert into public.user_roles (user_id, role) values
  ('d0000000-0000-0000-0000-0000000000a1','admin'),
  ('d0000000-0000-0000-0000-0000000000a2','user')
on conflict do nothing;

insert into public.pipelines (id, equipe_id, name) values
  ('22222222-2222-2222-2222-222222222222','11111111-1111-1111-1111-111111111111','Comercial');
...
insert into public.pipeline_stages_v2 (id, equipe_id, pipeline_id, name, position, stage_type, funnel_event) values
  ...
  ('a0000000-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111','22222222-2222-2222-2222-222222222222','Ganho',3,'won',null),
  ('a0000000-0000-0000-0000-000000000004','11111111-1111-1111-1111-111111111111','22222222-2222-2222-2222-222222222222','Perdido',4,'lost',null);
...
insert into public.leads (id, equipe_id, name, responsible_id, origin_category) values
  ('b0000000-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111','Lead do Chefe','d0000000-0000-0000-0000-0000000000a1','paid_social'),
  ('b0000000-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111','Lead do Vendedor','d0000000-0000-0000-0000-0000000000a2','referral');

insert into public.opportunities (id, equipe_id, lead_id, pipeline_id, stage_id, value) values
  ('c0000000-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111','b0000000-0000-0000-0000-000000000001','22222222-2222-2222-2222-222222222222','a0000000-0000-0000-0000-000000000001', 10000),
  ('c0000000-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111','b0000000-0000-0000-0000-000000000002','22222222-2222-2222-2222-222222222222','a0000000-0000-0000-0000-000000000001', 2000);
...
update public.opportunities set stage_id='a0000000-0000-0000-0000-000000000003', status='won', closed_at=now() where id='c0000000-0000-0000-0000-000000000001';
update public.opportunities set stage_id='a0000000-0000-0000-0000-000000000002' where id='c0000000-0000-0000-0000-000000000002';
update public.opportunities set stage_id='a0000000-0000-0000-0000-000000000004', status='lost', closed_at=now(), lost_reason='Preço' where id='c0000000-0000-0000-0000-000000000002';
...
values ('c0000000-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',
        ...
        'a0000000-0000-0000-0000-000000000001', 75000, 'open');
...
reset role;
insert into public.pipelines (id, equipe_id, name) values
  ('33333333-3333-3333-3333-333333333333','99999999-9999-9999-9999-999999999999','Outro');
insert into public.pipeline_stages_v2 (id, equipe_id, pipeline_id, name, position, stage_type) values
  ('a0000000-0000-0000-0000-0000000000f1','99999999-9999-9999-9999-999999999999','33333333-3333-3333-3333-333333333333','Ganho',1,'won');
insert into public.leads (id, equipe_id, name) values
  ('b0000000-0000-0000-0000-0000000000f1','99999999-9999-9999-9999-999999999999','Lead Alheio');
insert into public.opportunities (id, equipe_id, lead_id, pipeline_id, stage_id, value, status)
values ('c0000000-0000-0000-0000-0000000000f1','99999999-9999-9999-9999-999999999999',
        'b0000000-0000-0000-0000-0000000000f1','33333333-3333-3333-3333-333333333333',
        'a0000000-0000-0000-0000-0000000000f1', 999999, 'won');
